...
def main():
    ...
    template_path = os.path.join(base_dir, 'templates/nislscpyapi.py.mako')
    output_path = os.path.join(base_dir, 'nislscpyapi.py')
    try:
        ...
        rendered = tpl.render(functions=api['functions'], trim_blocks=True, lstrip_blocks=True, strict_undefined=True)
